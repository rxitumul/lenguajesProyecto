...
public class BibliotecaDeTokens {
    ...
    private Map<String, TokensDefinicion> reservadas = new HashMap<>();
    {
        ...
        reservadas.put("EJECUTAR",
                new TokensDefinicion("PALABRA_RESERVADA", "Palabra reservada para ejecutar una acción"));
        reservadas.put("contexto",
                new TokensDefinicion("PALABRA_RESERVADA", "Palabra reservada para definir el contexto"));
        reservadas.put("variable",
                new TokensDefinicion("PALABRA_RESERVADA", "Palabra reservada para definir una variable"));
        ...
        reservadas.put("SOBRE",
                new TokensDefinicion("CONECTORES", "Conector para definir sobre qué se aplica una acción"));
        reservadas.put("DESDE",
                new TokensDefinicion("CONECTORES", "Conector para definir desde dónde se aplica una acción"));
        ...
        reservadas.put("{", new TokensDefinicion("DELIMITADOR", "Llave de apertura de bloque"));
        reservadas.put("}", new TokensDefinicion("DELIMITADOR", "Llave de cierre de bloque"));
        reservadas.put(";", new TokensDefinicion("DELIMITADOR", "Llave de cierre de bloque"));
        ...
        reservadas.put("analista",
                new TokensDefinicion("OPERADORES_LITERALES_COMENTARIOS", "Palabra reservada para definir un analista"));
        reservadas.put("//", new TokensDefinicion("OPERADORES_LITERALES_COMENTARIOS", "Comentario de una línea"));
        reservadas.put("/* */",
                new TokensDefinicion("OPERADORES_LITERALES_COMENTARIOS", "Comentario de múltiples líneas"));
    }
